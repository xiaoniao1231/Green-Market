...
public interface ProductService {
    ...
    ProductsCheck sellerList(ProductsCheck productsCheck);

    //公开商品列表（买家端：仅在售、未删除，无需登录/开店)
    ProductsCheck publicList(ProductsCheck productsCheck);
    ...
    ProductsCheck recommend(ProductsCheck productsCheck);

    ProductsCheck search(ProductsCheck productsCheck);
}
